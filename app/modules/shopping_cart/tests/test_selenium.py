...
class TestTestseleniumdownloadcart:
    ...
    def test_testseleniumdownloadcart(self):
        ...
        self.driver.find_element(
            By.CSS_SELECTOR, ".list-group > .list-group-item > .list-group-item > .row .btn-outline-success"
        ).click()
        self.driver.find_element(
            By.CSS_SELECTOR, ".list-group-item > .list-group-item > .list-group-item .btn-outline-success"
        ).click()
        self.driver.find_element(By.CSS_SELECTOR, ".nav-icon > .feather-shopping-cart > path").click()
